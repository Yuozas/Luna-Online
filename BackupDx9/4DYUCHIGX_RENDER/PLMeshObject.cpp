...
//	return InitializeShader(m_pRenderer->GetDevice(),&m_vsHandle,dwDecl,"diffDot3Pix.vso",SHADER_TYPE_VERTEX_SHADER);
	...
	InitializeShader(m_pRenderer->GetDevice(),&m_vsHandle,NULL,"diffDot3Pix.vso",SHADER_TYPE_VERTEX_SHADER);
	InitializeShader(m_pRenderer->GetDevice(),&m_vsHandle,NULL,"diffDot3Pix.vsh",SHADER_TYPE_VERTEX_SHADER);

	InitializeShader(m_pRenderer->GetDevice(),&m_vsHandle,NULL,"VertexLightMesh.fx",SHADER_TYPE_VERTEX_SHADER);
	InitializeShader(m_pRenderer->GetDevice(),&m_vsHandle,NULL,"VertexLightMesh_Dummy.fx",SHADER_TYPE_VERTEX_SHADER);
	InitializeShader(m_pRenderer->GetDevice(),&m_vsHandle,NULL,"VertexLightMesh_Gray.fx",SHADER_TYPE_VERTEX_SHADER);

	InitializeShader(m_pRenderer->GetDevice(),&m_vsHandle,NULL,"3DSprite.fx",SHADER_TYPE_VERTEX_SHADER);
	InitializeShader(m_pRenderer->GetDevice(),&m_vsHandle,NULL,"BillBoard.fx",SHADER_TYPE_VERTEX_SHADER);
...
{	
	...
	InitializeShader(m_pRenderer->GetDevice(),&m_psHandle,NULL,"diff.psh",SHADER_TYPE_PIXEL_SHADER);
	InitializeShader(m_pRenderer->GetDevice(),&m_psDot3Handle,NULL,"diffDot3.psh",SHADER_TYPE_PIXEL_SHADER);
	InitializeShader(m_pRenderer->GetDevice(),&m_psDot3ReflectHandle,NULL,"diffDot3Reflect.psh",SHADER_TYPE_PIXEL_SHADER);
	InitializeShader(m_pRenderer->GetDevice(),&m_psOpasityHandle,NULL,"diffOpasity.psh",SHADER_TYPE_PIXEL_SHADER);
	
	InitializeShader(m_pRenderer->GetDevice(),&m_vsHandle,NULL,"3DSprite.fx",SHADER_TYPE_PIXEL_SHADER);
	InitializeShader(m_pRenderer->GetDevice(),&m_vsHandle,NULL,"BillBoard.fx",SHADER_TYPE_PIXEL_SHADER);
