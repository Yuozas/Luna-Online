...
CBattleSystem::~CBattleSystem()
{
	...
	// S ASSERT수정 추가 added by hseos 2007.06.25
	// ..CServerSystem::End() 에서 Release 를 하고 있음.
	// Release();
	// E ASSERT수정 추가 added by hseos 2007.06.25
}
...
{
	SHOWDOWNMGR->NetworkMsgParse( protocol, pMsg ); //Ã³¸®µÈ ¸Þ¼¼Áö´Â ¾Æ·¡·Î ³»·Á°¥ ÇÊ¿ä¾øµµ·Ï.
	...
	case MP_BATTLE_CHAT_MASTER_SYN:
		...
		break;
	case MP_BATTLE_SHOWDOWN_REQUEST_SYN:
		{
		}
		break;
