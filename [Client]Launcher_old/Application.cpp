...
{
	HANDLE hFile = CreateFile( lpszVerInfoFile,
		GENERIC_READ,
		0,
		NULL,
		OPEN_EXISTING,
	...
	{
		MessageBox( NULL, "Can't Open Version File", "오류", MB_OK );
		return FALSE;
	}
	
	DWORD dwBytesRead;
	DWORD dwReturn = ReadFile( hFile,
		lpszVerInfo,
	...
	{
		MessageBox( NULL, "Version File is Incorrect", "오류", MB_OK );
		return FALSE;
	}
