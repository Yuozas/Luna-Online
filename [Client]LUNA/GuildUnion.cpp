	...
	case MP_GUILD_UNION_MARK_REGIST_ACK:
		{
			...
			CHATMGR->AddMsg( CTC_GUILD_NOTICE, CHATMGR->GetChatMsg(1018) );
	...
	case MP_GUILD_UNION_NOTE_ACK:	
		{
			...
			//CHATMGR->AddMsg(CTC_TOWHOLE, "[쪽지] 전체 동맹 문파에 쪽지를 발송했습니다." );
	...
	case MP_GUILD_UNION_DESTROY_NACK:
		{
			...
			case eGU_Is_GuildFieldWar:
				{
					//CHATMGR->AddMsg( CTC_GUILD_NOTICE, "전쟁 중에 해체할 수 없습니다" );
