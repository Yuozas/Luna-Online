...
//	ELSEIF( buf, "&SKILL",		eGameEvent_SkillInterface, pData->m_dwKind )
...
//	ELSEIF( buf, "&SKILL0",	eGameEvent_Skill0, pData->m_dwKind )
//	ELSEIF( buf, "&SKILL1",	eGameEvent_Skill1, pData->m_dwKind )
//	ELSEIF( buf, "&LEVEL",		eGameEvent_LevelUp, pData->m_dwKind )
//	ELSEIF( buf, "&MAP",		eGameEvent_MapChange, pData->m_dwKind )
//	
//	if( strcmp(buf, "&LEVEL") == 0 || strcmp(buf, "&MAP") == 0 )
//	{
...
//	case eGameEvent_SkillInterface:	CheckElse( eGameEvent_SkillInterface );	break;	
...
//	case eGameEvent_Skill0:			CheckElse( eGameEvent_Skill0 );			break;
//	case eGameEvent_Skill1:			CheckElse( eGameEvent_Skill1 );			break;
//		
