...
void CStorageManager::NetworkMsgParse(BYTE Protocol,void* pMsg)
{
	...
	{
		/*
		// 071227 LUJ, SEND_HERO_TOTALINFO에서 이 정보를 포함시켜 초기화가 비동기적으로 될 위험을 없앤다
	case MP_STORAGE_INFO:
		{
...
{	
	...
	if(vals)
	{
		cDivideBox * pDivideBox = WINDOWMGR->DivideBox( DBOX_INPUT_MONEY, (LONG)(pStorageMoney->GetAbsX()-50), 
