...
// 070510 LYW --- EngineObject : Add function to detach shield.
void CEngineObject::RemoveShieldAttachedDress()
{
	CEngineObject* pShield;
	while(pShield = (CEngineObject*)m_AttachedDress.RemoveTail())
	{
		Detach(pShield);
		delete pShield;		
	}
