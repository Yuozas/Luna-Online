...
void cHelperManager::Init()
{
	if( !m_bInit )
	{
		...
		m_pDialogue->LoadDialogueListFile("./Data/Interface/Windows/Helper_Msg.bin", "rb");
	...
	m_pSpeechDlg = (cHelperSpeechDlg*)SCRIPTMGR->GetDlgInfoFromFile("./Data/Interface/Windows/34.bin", "rb");
...
{
	CMHFile fp;
	if(!fp.Init("./Data/Interface/Windows/HelperSpeech_List.bin", "rb"))
		return;
	char buff[256]={0,};
...
{
	CMHFile fp;
	if(!fp.Init("./Data/Interface/Windows/Helper.bin", "rb"))
		return;
