...
//	font.lfHeight = -12;
	...
	font.lfHeight = -MulDiv(9, nNumerator, 72);						// 첫번째 인수와 두번째 인수를 곱하고, 그 결과를 세번째 인수로 나눈 결과를 리턴해준다.(오버플로나, 나누기 값이 0인경우는 -1을리턴한다.)
//	font.lfHeight = -12;
	font.lfWidth = -font.lfHeight / 2;
	font.lfEscapement = 0;
	font.lfOrientation = 0;
