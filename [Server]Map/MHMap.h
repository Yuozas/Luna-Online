...
////KES
	WORD GetChannelNum() {return m_msDesc.ChannelNum;}
	BOOL IsVillage() { return m_msDesc.bVillage; }
	BOOL IsPKAllow() { return m_msDesc.bPKAllow; }
	WORD GetMaxDBThread() { return m_msDesc.MaxDBThread; }
	WORD GetMaxQueryInSameTime() { return m_msDesc.MaxQueryInSameTime; }
