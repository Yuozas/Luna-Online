...
//struct TMSG_CHARACTER_SKILLINFO : public TMSGBASE
//{
//	SKILL_TOTALINFO	m_sSkillInfo;
//};

struct TMSG_CHARACTER_SKILLINFO2 : public TMSGBASE
{
	DWORD			m_dwCount;
	SKILLBASE		m_SkillBase[5];
};
/*어빌리티 삭제 - 
...
struct TMSG_SKILL_EDIT : public TMSGBASE
{
	DWORD				dwData;
	char				sName[17];
	SKILLBASE			Skill;
