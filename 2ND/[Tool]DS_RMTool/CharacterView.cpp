...
void CCharacterView::UpdateUsingShopItemInfo( TMSG_USINGSHOPITEMINFO* pMsg )
{
	GetCharacterInfoPage()->UpdateUsingShopItemInfo( pMsg );
}

void CCharacterView::UpdateMainPetListData( TMSG_MAINPETLIST* pMsg )
{
	GetCharacterInfoPage()->UpdateMainPetListData( pMsg );
}