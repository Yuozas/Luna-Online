...
BEGIN_MESSAGE_MAP(CMainFrame, CMDIFrameWnd)
	...
	ON_COMMAND(ID_PET, OnPet)
	ON_COMMAND(ID_DEL_CHAR, OnDelChar)	
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
{
	if( OperatorPowerCheck( eOperPower_Eventer ) )
	{
...
void CMainFrame::OnMunpainfo() 
{
	...
	if( OperatorPowerCheck( eOperPower_Master ) ||
		...
		OperatorPowerCheck( eOperPower_QA ) )
	{
		CDS_RMToolApp* pApp = (CDS_RMToolApp*)AfxGetApp();
...
void CMainFrame::OnPet() 
{	
	if( OperatorPowerCheck( eOperPower_Master ) || OperatorPowerCheck( eOperPower_Auditor) )
	{
		CDS_RMToolApp* pApp = (CDS_RMToolApp*)AfxGetApp();
		pApp->OpenNewTemplate(eTemp_Pet);	
	}
	else
	{
		MessageBox( "Your Power Is Not Right!!", "Error" );
...
void CMainFrame::OnDelChar() 
{	
	if( OperatorPowerCheck( eOperPower_Master ) || OperatorPowerCheck( eOperPower_Auditor) )
	{
		CDS_RMToolApp* pApp = (CDS_RMToolApp*)AfxGetApp();
		pApp->OpenNewTemplate(eTemp_DelChar);	
	}
	else
	{
		MessageBox( "Your Power Is Not Right!!", "Error" );
