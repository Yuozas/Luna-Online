...
public:
	...
	CMRButton		m_SkillMuGong[SLOT_MUGONG_NUM+SLOT_MUGONG_NUM];			// Skill̢
	...
	CUsingShopDlg	m_UsingShopDlg;

	CPetListDlg		m_PetListDlg;
...
public:
	...
	void	MakeToolTip(BYTE type, POSTYPE pos, DWORD idx, char* str);
	void	ResetTooltip();
...
////////////////////////////////////////////////
	...
	void	UpdateMainPetListData( TMSG_MAINPETLIST* pMsg );

// Dialog Data
	//{{AFX_DATA(CCharacterInfo)
	enum { IDD = IDD_CHAR_PAGE };
	CButton	m_btnCheckShop;
	CComboBox	m_cbShopWare;
...
protected:
	...
	afx_msg void OnCheckShop();
	afx_msg void OnSelchangeComboShopware();
	afx_msg void OnBtnUsingShopitem();
	afx_msg void OnBnClickedPetlist();
	//}}AFX_MSG
