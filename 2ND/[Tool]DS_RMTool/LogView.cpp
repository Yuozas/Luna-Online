...
/* --------------------------------------------------------------------------
* 함수이름 : SetGMToolCharacterIdx
* 목    적 : GMTOOL 로그뷰에서 캐릭터 인덱스를 가져옴
* 주의사항 :
*---------------------------------------------------------------------------*/
...
/* --------------------------------------------------------------------------
* 함수이름 : SetLogGuildTN
* 목    적 : cLogGuildtnPage 클래스에서 setLogGuildTN함수 호출
* 주의사항 :
*---------------------------------------------------------------------------*/
...
/* --------------------------------------------------------------------------
* 함수이름 : SetLogGMTool
* 목    적 : gmtool log 서버에서 받은 데이타 출력 호출
* 주의사항 :
*---------------------------------------------------------------------------*/
